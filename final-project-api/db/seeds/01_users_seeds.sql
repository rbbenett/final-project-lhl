INSERT INTO users (username, first_name, last_name, email, password, avatar, city, country, words_per_min, highest_level_cleared)
VALUES 
('Jsmith', 'Jaden', 'Smith', 'jsmith@gmail.com', password, null, 'Toronto', 'Canada', 66.73, 5),
...
('Tfox', 'terry@fox.com', 'sweetcharity', null, 'Toronto', 'Canada', 0, 0)